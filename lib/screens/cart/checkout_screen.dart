...
import 'package:thue_do_cosplay/screens/cart/components/checkout_form.dart';
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: DefaultButton(
                      text: "Đặt hàng",
                      press: () async {
                        if (checkoutForm.formKey.currentState!.validate()) {
                          checkoutForm.formKey.currentState!.save();
                          // print(checkoutForm.addressText.text);
                          // print(checkoutForm.noteText.text);
                          String res = 'Có lỗi xảy ra, vui lòng thử lại!';
                          // if (Provider.of<Calculate>(context, listen: false)
                          //         .num >
                          //     0) {
